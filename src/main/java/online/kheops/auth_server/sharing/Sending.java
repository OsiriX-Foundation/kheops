...
public class Sending {
    ...
    public static void deleteStudyFromAlbum(User callingUser, long albumPk, String studyInstanceUID)
    ...
    public static void deleteSeriesFromAlbum(User callingUser, long albumPk, String studyInstanceUID, String seriesInstanceUID)
            throws AlbumNotFoundException, SeriesNotFoundException {
