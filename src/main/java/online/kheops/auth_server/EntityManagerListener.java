...
public class EntityManagerListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        properties.put("javax.persistence.jdbc.url", event.getServletContext().getInitParameter("online.kheops.jdbc.url") + "?verifyServerCertificate=false&useUnicode=yes&amp;characterEncoding=UTF-8");
