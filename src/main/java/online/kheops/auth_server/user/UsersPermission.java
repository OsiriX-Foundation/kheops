...
public class UsersPermission {
    ...
    public enum UsersPermissionEnum {ADD_USER, REMOVE_USER, ADD_ADMIN, REMOVE_ADMIN, DOWNLOAD_SERIES, SEND_SERIES, DELETE_SERIES, ADD_SERIES, READ_SERIES, WRITE_COMMENT, EDIT_ALBUM, DELETE_ALBUM, LIST_USERS}
