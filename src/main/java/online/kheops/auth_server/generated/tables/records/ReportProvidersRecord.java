...
public class ReportProvidersRecord extends UpdatableRecordImpl<ReportProvidersRecord> implements Record6<Long, Long, Timestamp, String, String, String> {

    private static final long serialVersionUID = -1342390443;
     ...
     */
    @Override
    public Row6<Long, Long, Timestamp, String, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row6<Long, Long, Timestamp, String, String, String> valuesRow() {
     ...
     */
    @Override
    public ReportProvidersRecord values(Long value1, Long value2, Timestamp value3, String value4, String value5, String value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ReportProvidersRecord(Long pk, Long albumFk, Timestamp creationTime, String name, String url, String clientId) {
        super(ReportProviders.REPORT_PROVIDERS);
