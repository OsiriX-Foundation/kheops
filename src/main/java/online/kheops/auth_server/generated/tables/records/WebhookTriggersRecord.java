...
public class WebhookTriggersRecord extends UpdatableRecordImpl<WebhookTriggersRecord> implements Record6<Long, String, Long, Boolean, Boolean, Boolean> {

    private static final long serialVersionUID = -313359049;
     ...
     */
    @Override
    public Row6<Long, String, Long, Boolean, Boolean, Boolean> fieldsRow() {
     ...
     */
    @Override
    public Row6<Long, String, Long, Boolean, Boolean, Boolean> valuesRow() {
     ...
     */
    @Override
    public WebhookTriggersRecord values(Long value1, String value2, Long value3, Boolean value4, Boolean value5, Boolean value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WebhookTriggersRecord(Long pk, String id, Long webhookFk, Boolean isManualTrigger, Boolean newSeries, Boolean newUser) {
        super(WebhookTriggers.WEBHOOK_TRIGGERS);
