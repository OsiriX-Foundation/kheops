...
public class AlbumsRecord extends UpdatableRecordImpl<AlbumsRecord> implements Record12<Long, String, String, String, Timestamp, Timestamp, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean> {

    private static final long serialVersionUID = 2097037126;
     ...
     */
    @Override
    public Row12<Long, String, String, String, Timestamp, Timestamp, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean> fieldsRow() {
     ...
     */
    @Override
    public Row12<Long, String, String, String, Timestamp, Timestamp, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean> valuesRow() {
     ...
     */
    @Override
    public AlbumsRecord values(Long value1, String value2, String value3, String value4, Timestamp value5, Timestamp value6, Boolean value7, Boolean value8, Boolean value9, Boolean value10, Boolean value11, Boolean value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AlbumsRecord(Long pk, String id, String name, String description, Timestamp createdTime, Timestamp lastEventTime, Boolean addUserPermission, Boolean downloadSeriesPermission, Boolean sendSeriesPermission, Boolean deleteSeriesPermission, Boolean addSeriesPermission, Boolean writeCommentsPermission) {
        super(Albums.ALBUMS);
