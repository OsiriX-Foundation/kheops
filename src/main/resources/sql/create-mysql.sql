...
create table series (pk bigint not null auto_increment, created_time datetime not null, expiration_date varchar(255), modality varchar(255), series_uid varchar(255) not null, study_uid varchar(255) not null, series_size bigint not null, updated_time datetime not null, primary key (pk));
