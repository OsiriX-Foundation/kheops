<template>
  <span>
    ...
    >
      ...
      <li v-if="trigger.user.first_name !== undefined">{{ $t('user.firstname') }} : {{ trigger.user.first_name }}</li>
      <li v-if="trigger.user.last_name !== undefined">{{ $t('user.lastname') }} : {{ trigger.user.last_name }}</li>
